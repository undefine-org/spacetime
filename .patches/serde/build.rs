...
// Backward-compat alias: old crates (swc_config 3.0.0, swc_common 9.2.0) reference
// serde::__private which was renamed to serde::__private$$ in the serde_core split.
#[doc(hidden)]
pub mod __private {
    #[doc(hidden)]
    pub use crate::private::*;
